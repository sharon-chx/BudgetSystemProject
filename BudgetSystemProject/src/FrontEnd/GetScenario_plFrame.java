...
public class GetScenario_plFrame extends GetScenarioFrame implements ActionListener{

	GetScenario_plFrame(BudgetSystem budgetSystem) {
		super(budgetSystem);
